...
const HomePage = () => {
    ...
    return (
        <>
            ...
            <Row>
                <Col span={12}>
                    <Statistic title='Total crypto currencies' value={globalStats.total}></Statistic>
                </Col>
                <Col span={12}>
            ...
            <div className="home-heading-container">
                <Title level={2} className='home-title'>Top 10 Cryptocurrencies in the world now</Title>
